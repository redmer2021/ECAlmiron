    ...
    <>
        <div className="px-6 md:px-16 lg:w-[90%] xl:w-[85%] mx-auto grid md:grid-cols-2 mb-[5rem] md:mt-[3rem]">
            ...
            <div className="border border-black rounded-md p-[1rem] md:p-[2rem] mx-4">
                <CampTexto classname='mb-4 font-Roboto border border-gray-400 w-full p-2 rounded-md' onchange={actualizDtosContacto} name='nombre'>Nombre</CampTexto>
                <CampTexto classname='mb-4 font-Roboto border border-gray-400 w-full p-2 rounded-md' onchange={actualizDtosContacto} name='email'>Correo Electrónico</CampTexto>
                <AreaTexto classname='mb-4 font-Roboto border border-gray-400 w-full p-2 rounded-md min-h-[10rem] max-h-[12rem]' onchange={actualizDtosContacto} name='mensaje'>Mensaje</AreaTexto>
